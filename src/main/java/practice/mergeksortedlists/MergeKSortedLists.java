...
public class MergeKSortedLists {
    ...
    // Chooses the smaller head, links it to the result of merging the remainder, and returns the
    // chosen node.
...
- This reflects the maximum extra space used by the implementations in this file
  (heap storage and pointer overhead).
- Note: recursive divide-and-conquer also uses recursion stack space (O(log k)),
  but the worst-case auxiliary space across the provided approaches is O(k).
*/
