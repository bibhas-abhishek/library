...
public class LargestSquareInMatrix {
    ...
    /**
     * Compute the side length of the largest square containing only 1s. Uses dynamic programming
     * where dp[i][j] stores the side length of the largest square whose bottom-right corner is at
     * matrix[i-1][j-1].
     */
